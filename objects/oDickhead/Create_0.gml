...
var sex = "wow you figured out how to use fuckin Undertale Modding Tool im so proud of you!!!"
var funny = "dont press the Fn key on the level select"
...
//initiate rolling
if (key_down && !roll && state = states.normal && (place_meeting(x,y+1,oCollide)||position_meeting(x,y+1,o1Way))) {
	if (room = rFishing) { 
