...
// Feather disable all
// Generated at 2022-12-01 16:22:45 (20710ms) for v2.3.7+
/// @lint nullToAny true
// Feather disable all
#region prototypes
...
mt_gml_token = new gml_std_haxe_enum(-1, "gml_token", ["header", "macro_def", "macro_start", "hash", "semico", "comma", "period", "colon", "qmark", "at_sign", "dollar_sign", "keyword", "ident", "undefined_hx", "number", "cstring", "un_op", "adjfix", "bin_op", "set_op", "par_open", "par_close", "sqb_open", "sqb_close", "cub_open", "cub_close", "arg_const", "null_co", "null_co_set", "pragma"]);
...
function compile_groups_gml_compile_group_literal_proc(l_q, l_actions, l_out) {
	...
	switch (l__g.__enumIndex__/* gml_node */) {
		...
		case 1/* number */: if (l_out) ds_list_add(l_actions, gml_action_number(l__g.h_d, l__g.h_value)); break;
		case 2/* cstring */: if (l_out) ds_list_add(l_actions, gml_action_cstring(l__g.h_d, l__g.h_value)); break;
		case 18/* const */: if (l_out) ds_list_add(l_actions, gml_action_const(l__g.h_d, gml_const_val.h_obj[$ l__g.h_name])); break;
		case 3/* other_const */: if (l_out) ds_list_add(l_actions, gml_action_const(l__g.h_d, l__g.h_value)); break;
		case 13/* self_hx */:
			var l_d = l__g.h_d;
			if (l_out) {
		...
		case 14/* other_hx */:
			...
			break;
		case 15/* global_ref */: if (l_out) ds_list_add(l_actions, gml_action_number(l__g.h_d, -5)); break;
		case 16/* script */: ds_list_add(l_actions, gml_action_func_literal(l__g.h_d, l__g.h_ref.h_name)); break;
		case 17/* native_script */: ds_list_add(l_actions, gml_action_const(l__g.h_d, l__g.h_id)); break;
		case 5/* array_decl */:
		...
		case 6/* object_decl */:
			...
			for (var l__g2 = array_length(l_w); l_i < l__g2; l_i++) {
				...
				var l__g3 = l_x;
				var l_bindFunc;
				l_bindFunc = (l__g3.__enumIndex__ == 31);
...
function compile_gml_compile_args_get_simple(l_q) {
	...
	switch (l__g.__enumIndex__/* gml_node */) {
		case 52/* field */:
			if (l__g.h_obj.__enumIndex__/* gml_node */ == 13/* self_hx */) {
...
function compile_gml_compile_call_func_proc(l_actions, l_d, l_fn, l_args1, l_out) {
	...
	if (l_funcFlags == 0 && l_argc > 0 && l_argc <= 5) {
		var l__g = l_args1[0];
		if (l__g.__enumIndex__/* gml_node */ == 42/* local_hx */) {
...
function compile_groups_gml_compile_group_local_proc(l_q, l_actions, l_out) {
	...
	switch (l__g.__enumIndex__/* gml_node */) {
		...
		case 45/* static_decl */:
			...
			break;
		case 46/* static */: ds_list_add(l_actions, vm_v2_gml_action_closure_bind(l__g.h_d, "static[]", { ind: gml_compile_curr_script.h_static_map.h_obj[$ l__g.h_name], values: gml_compile_curr_script.h_static_values }, compile_groups_gml_compile_group_local_proc_lf22)); break;
		case 47/* static_set */:
			var l_d = l__g.h_d;
			if (gml_compile_curr_script.h_is_constructor) return compile_groups_gml_compile_group_local_no_static_writes(l_d);
			if (gml_compile_node(l__g.h_val, l_actions, true)) return true;
...
function compile_gml_compile_bin_op_proc(l_actions, l_d, l_o, l_a, l_b) {
	if (gml_op_is_simple(l_o)) {
		var l_ai;
		var l__g = l_a;
		if (l__g.__enumIndex__/* gml_node */ == 42/* local_hx */) l_ai = gml_compile_curr_script.h_local_map.h_obj[$ l__g.h_name]; else l_ai = -1;
		var l_bi;
		var l__g = l_b;
		if (l__g.__enumIndex__/* gml_node */ == 42/* local_hx */) l_bi = gml_compile_curr_script.h_local_map.h_obj[$ l__g.h_name]; else l_bi = -1;
		if (l_ai >= 0) {
			if (l_bi >= 0) {
...
function compile_gml_compile_delete_proc(l_actions, l_d, l_x) {
	...
	switch (l__g.__enumIndex__/* gml_node */) {
		case 42/* local_hx */:
			...
			break;
		case 49/* global_hx */: ds_list_add(l_actions, vm_v2_gml_action_closure_bind(l_d, "delete global", { varname: l__g.h_name }, compile_gml_compile_delete_proc_lf1)); break;
		case 52/* field */:
			var l__g1 = l__g.h_obj;
			if (l__g1.__enumIndex__/* gml_node */ == 13/* self_hx */) {
				if (gml_compile_node(l_x, l_actions, true)) return true;
...
function compile_groups_gml_compile_group_array_proc(l_q, l_actions, l_out) {
	...
	switch (l__g.__enumIndex__/* gml_node */) {
		case 67/* index */:
			...
			var l_i;
			var l__g1 = l_arr;
			if (l__g1.__enumIndex__/* gml_node */ == 42/* local_hx */) l_i = gml_compile_curr_script.h_local_map.h_obj[$ l__g1.h_name]; else l_i = -1;
			if (l_i >= 0) {
			...
			var l__g1 = l_arr;
			if (l__g1.__enumIndex__/* gml_node */ == 52/* field */) {
				if (l__g1.h_obj.__enumIndex__/* gml_node */ == 13/* self_hx */) {
...
function data_gml_keyword_mapper_init_v1(l_d) {
	return gml_token_number(l_d, 1, undefined);
}

if (live_enabled) 
function data_gml_keyword_mapper_init_v2(l_d) {
	return gml_token_number(l_d, 0, undefined);
}
...
function gml_seek_alarms_check(l_x) {
	var l__g = l_x;
	if (l__g.__enumIndex__/* gml_node */ == 52/* field */) {
...
function gml_seek_arguments_proc(l_q, l_st) {
	...
	var l__g = l_q;
	if (l__g.__enumIndex__/* gml_node */ == 19/* arg_const */) {
...
function gml_seek_calls_proc(l_q, l_st) {
	var l_n, l_s;
	var l__g = l_q;
	if (l__g.__enumIndex__/* gml_node */ == 22/* call */) {
		var l_d = l__g.h_d;
		var l_x = l__g.h_expr;
		...
		switch (l__g.__enumIndex__/* gml_node */) {
			case 16/* script */:
				...
				break;
			case 52/* field */: gml_std_haxe_enum_tools_setTo(l_q, gml_node_call_field(l_d, l__g.h_obj, l__g.h_field, l_args1)); break;
			case 12/* ident */:
				var l_s1 = l__g.h_id;
...
function gml_seek_enum_fields_proc_one(l_q, l_st) {
	...
	if (l__g.__enumIndex__/* gml_node */ == 52/* field */) {
		...
		var l__g = l_x;
		if (l__g.__enumIndex__/* gml_node */ == 12/* ident */) {
			var l_s = l__g.h_id;
...
function gml_seek_fields_proc(l_q, l_st) {
	...
	if (l__g.__enumIndex__/* gml_node */ == 52/* field */) {
		...
		if (l_x.__enumIndex__/* gml_node */ == 15/* global_ref */) gml_std_haxe_enum_tools_setTo(l_q, gml_node_global_hx(l_d, l_s));
	}
	return gml_node_tools_seek(l_q, l_st, gml_program_seek_func);
}
			...
			if (ds_list_size(l_st) > 0) {
				...
				switch (l__g.__enumIndex__/* gml_node */) {
					case 67/* index */:
						...
						break;
					case 70/* index2d */: return gml_program_seek_inst.h_error("`" + l_s + "` is not a 2d array.", l__g.h_d);
