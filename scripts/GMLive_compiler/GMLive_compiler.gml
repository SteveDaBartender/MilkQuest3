...
function gml_compile_const_val_of(l_q) {
	...
	switch (l__g.__enumIndex__/* gml_node */) {
		...
		case 1/* number */: l_tmp = l__g.h_value; break;
		case 2/* cstring */: l_tmp = l__g.h_value; break;
		case 3/* other_const */: l_tmp = l__g.h_value; break;
		case 18/* const */: l_tmp = gml_const_val.h_obj[$ l__g.h_name]; break;
...
function gml_compile_node(l_q, l_actions, l_out) {
	...
	var l__g = l_q;
	switch (l__g.__enumIndex__/* gml_node */) {
		case 7/* ensure_array_for_local */: ds_list_add(l_actions, gml_action_ensure_array_for_local(l__g.h_d, gml_compile_curr_script.h_local_map.h_obj[$ l__g.h_name])); break;
		case 8/* ensure_array_for_global */: ds_list_add(l_actions, gml_action_ensure_array_for_global(l__g.h_d, l__g.h_name)); break;
		...
		case 41/* in */:
			...
			var l__g1 = l__field;
			if (l__g1.__enumIndex__/* gml_node */ == 2/* cstring */) {
				if (gml_compile_node(l__g.h_obj, l_actions, true)) return true;
			...
			break;
		case 49/* global_hx */: ds_list_add(l_actions, gml_action_global_hx(l__g.h_d, l__g.h_name)); break;
		case 50/* global_set */:
		...
		case 52/* field */:
			...
			switch (l__g1.__enumIndex__/* gml_node */) {
				case 13/* self_hx */: if (l_fastGetter != undefined) ds_list_add(l_actions, gml_action_fast_self_field(l__g.h_d, l_fastGetter)); else ds_list_add(l_actions, gml_action_self_field(l__g.h_d, l_s)); break;
				case 42/* local_hx */:
		...
		case 66/* alarm_aop */:
			...
			break;
		case 55/* env */: ds_list_add(l_actions, gml_action_env(l__g.h_d, l__g.h_v.h_func)); break;
		case 56/* env_set */:
			var l_av = l__g.h_v;
			if (gml_compile_node(l__g.h_val, l_actions, true)) return true;
		...
		case 63/* env1d_aop */:
			...
			break;
		case 19/* arg_const */: ds_list_add(l_actions, gml_action_arg_const(l__g.h_d, l__g.h_index)); break;
		case 20/* arg_index */:
			if (gml_compile_node(l__g.h_index, l_actions, true)) return true;
			ds_list_add(l_actions, gml_action_arg_index(l__g.h_d));
			break;
		case 21/* arg_count */: ds_list_add(l_actions, gml_action_arg_count(l__g.h_d)); break;
		case 36/* set_op */:
			l_d = l__g.h_d;
			l_o = l__g.h_op;
			l_x = l__g.h_a;
			...
			break;
		case 35/* bin_op */: compile_gml_compile_bin_op_proc(l_actions, l__g.h_d, l__g.h_op, l__g.h_a, l__g.h_b); break;
		case 34/* un_op */:
			if (gml_compile_node(l__g.h_expr, l_actions, true)) return true;
			ds_list_add(l_actions, gml_action_un_op(l__g.h_d, l__g.h_op));
			break;
		case 32/* prefix */: compile_gml_compile_adjfix_proc(l__g.h_d, l__g.h_expr, true, l__g.h_inc, l_actions, l_out); break;
		case 33/* postfix */: compile_gml_compile_adjfix_proc(l__g.h_d, l__g.h_expr, false, l__g.h_inc, l_actions, l_out); break;
		case 23/* call_script */:
			l_d = l__g.h_d;
			l_w = l__g.h_args;
		...
		case 28/* call_func */: compile_gml_compile_call_func_proc(l_actions, l__g.h_d, l__g.h_func, l__g.h_args, l_out); break;
		case 31/* func_literal */: ds_list_add(l_actions, gml_action_func_literal(l__g.h_d, l__g.h_name)); break;
		case 92/* block */:
			l_w = l__g.h_nodes;
			l_n = array_length(l_w);
			if (l_n > 0) {
		...
		case 99/* do_until */:
			...
			if (gml_compile_node(l__g.h_cond, l_actions, true)) return true;
			var l__g1 = l_q;
			if ((l__g1.__enumIndex__ == 99)) ds_list_add(l_actions, gml_action_jump_unless(l_d, l_p0)); else ds_list_add(l_actions, gml_action_jump_if(l_d, l_p0));
			l_p2 = ds_list_size(l_actions);
		...
		case 96/* wait */:
			...
			break;
		case 37/* delete_hx */: if (compile_gml_compile_delete_proc(l_actions, l__g.h_d, l__g.h_expr)) return true; break;
		case 97/* fork */: ds_list_add(l_actions, gml_action_fork(l__g.h_d, l_out)); break;
